                ...
                <form className="mt-8 space-y-0" >
                    ...
                    <div className=" shadow-sm -space-y-px">
                        ...
                        <div>
                            ...
                            <input id="password" name="password" type={passwordShown ? "text" : "password"} autoComplete="current-password" required className="appearance-none rounded block w-full px-3 py-2 my-2 border border-gray-300 placeholder-gray-500 text-gray-900 rounded-b-md focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 focus:z-10 sm:text-sm" placeholder="Password" />
                        </div>
                    </div>
                    ...
                    <div className="flex items-center justify-between pb-2">
                        <div className="flex items-center">
                            ...
                            <Link to='/register'><label htmlFor="" className="ml-2 block text-sm  font-medium text-indigo-600 hover:text-indigo-500" >
